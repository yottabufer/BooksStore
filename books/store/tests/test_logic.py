...
class SetRatingTestCase(TestCase):
    def setUp(self):
        user1 = User.objects.create(username='user1', first_name='first_name1', last_name='last_name2')
        user2 = User.objects.create(username='user2', first_name='111', last_name='222')
